...
module tt_um_vga_example(
  ...
  wire any_dots =
    ...
    (|dots[8])  || (|dots[9])  || (|dots[10]) || (|dots[11]) ||
    (|dots[12]) || (|dots[13]) || (|dots[14]) || (|dots[15]);
  ...
  // Pac-Man - prosty pełny kwadrat
  wire pac_on =
    board_area && pac_tile &&
    (cell_x >= 4'd2) && (cell_x <= 4'd13) &&
    (cell_y >= 4'd2) && (cell_y <= 4'd13);

  // Ghost - prosty pełny kwadrat
  wire ghost_on =
